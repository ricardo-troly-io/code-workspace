...
staffs = {
    "Abraham" =>        { :start => '2013-05-01', :end => '2015-07-08', :dpw => 5, :role => :dev }, 
    "Atif" =>           { :start => '2011-03-01', :end => '2099-01-01', :dpw => 3, :role => :mgmt }, 
    "Benjamin" =>       { :start => '2014-05-19', :end => '2017-03-10', :dpw => 5, :role => :dev }, 
    "Craig" =>          { :start => '2012-09-01', :end => '2015-12-10', :dpw => 2, :role => :mgmt }, 
    "Daniele" =>        { :start => '2013-04-23', :end => '2017-12-01', :dpw => 1, :role => :dev }, 
    "Daisy" =>          { :start => '2013-11-13', :end => '2016-01-29', :dpw => 5, :role => :dev }, 
    "Evan" =>           { :start => '2014-05-19', :end => '2016-02-26', :dpw => 5, :role => :dev }, 
    ...
    "Mora" =>           { :start => '2012-08-06', :end => '2016-01-25', :dpw => 5, :role => :mgmt }, 
    "Nishat" =>         { :start => '2012-07-01', :end => '2014-01-31', :dpw => 4, :role => :dev }, 
    "Nishat2" =>        { :start => '2015-11-01', :end => '2016-11-20', :dpw => 5, :role => :dev }, 
    "Sebastien" =>      { :start => '2011-03-01', :end => '2099-01-01', :dpw => 3, :role => :mgmt }, 
    "Andrew" =>         { :start => '2016-02-27', :end => '2016-12-22', :dpw => 4, :role => :dev }, 
    "Byron" =>          { :start => '2015-08-03', :end => '2016-01-08', :dpw => 5, :role => :dev }, 
    "Fakhar" =>         { :start => '2016-02-01', :end => '2016-05-03', :dpw => 5, :role => :dev }, 
    "Laura" =>          { :start => '2016-03-15', :end => '2016-05-15', :dpw => 4, :role => :dev }, 
    "Patricia" =>       { :start => '2016-06-14', :end => '2017-07-24', :dpw => 4, :role => :mgmt }, 
    "Svenja" =>         { :start => '2015-11-24', :end => '2016-06-30', :dpw => 4, :role => :mgmt }, 
    "Stephen" =>        { :start => '2016-01-01', :end => '2017-01-31', :dpw => 2, :role => :mgmt }, 
    "James" =>          { :start => '2016-01-20', :end => '2099-01-01', :dpw => 3, :role => :dev }, 
    "Josh" =>           { :start => '2016-02-01', :end => '2099-01-01', :dpw => 3, :role => :dev }, 
    "Xiangwei" =>       { :start => '2017-01-04', :end => '2099-01-01', :dpw => 5, :role => :dev } 
}
